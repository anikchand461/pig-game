...
function initGame() {
	...
	document.querySelectorAll('.player-info').forEach((player) => player.style.backgroundColor = '#d3d3d3');
	document.getElementById(`player-${activePlayer + 1}`).style.backgroundColor = '#0fff0d';
}
